let codePosts = [
    ...
    },
    {
        ...
        title: "P12",
        year: "2022",
        desc: "I worked on developing frontend components for P12's landing page, learning and improving my problem solving and technical skills over existing code in a bilingual team setting.",
        images: ["/code/p12.jpg"],
        genre: ["Frontend"],
